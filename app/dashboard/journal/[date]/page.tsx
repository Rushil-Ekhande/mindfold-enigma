          ...
          {!isFuture && (
            <div className="bg-white rounded-xl border border-border p-6">
              <textarea
                ...
                className={`w-full h-64 px-4 py-3 border border-border rounded-xl resize-none focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary transition-colors text-foreground ${
